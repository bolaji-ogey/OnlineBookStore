...
public class InvalidDataAccessResourceUsageException extends NonTransientDataAccessException {
    ...
    public InvalidDataAccessResourceUsageException(@Nullable String msg) {
        ...
        /* 0: aload_0
         * 1: aload_1
         * 2: invokespecial #1                  // Method org/springframework/dao/NonTransientDataAccessException."<init>":(Ljava/lang/String;)V
         * 5: return
         *  */
        // </editor-fold>
    }
    ...
    public InvalidDataAccessResourceUsageException(@Nullable String msg, @Nullable Throwable cause) {
         ...
         * 1: aload_1
         * 2: aload_2
         * 3: invokespecial #7                  // Method org/springframework/dao/NonTransientDataAccessException."<init>":(Ljava/lang/String;Ljava/lang/Throwable;)V
         * 6: return
         *  */
        // </editor-fold>
    }
